...
class Lokasi extends BaseController
{
    ...
    public function editLokasi($wilayah, $id_lokasi)
    {
        $lokasi = null;
        $selectedRegion = $wilayah;
        ...
        $data = [
            'judul' => 'Edit Lokasi ' . ucfirst($wilayah),
            'page' => 'lokasi/v_editlokasi',
            'lokasi' => $lokasi,
            'selectedRegion' => $selectedRegion
        ];
    ...
    //FUNGSI UPDATE
    public function updateData($id_lokasi, $wilayah)
    {
        ...
        if ($this->validate([
            ...
            switch ($wilayah) {
                case 'sleman':
                    $this->ModelLokasi->updateDataSleman($id_lokasi, $data);
                    break;
                case 'kota':
                    $this->ModelLokasi->updateDataKota($id_lokasi, $data);
                    break;
                case 'bantul':
                    $this->ModelLokasi->updateDataBantul($id_lokasi, $data);
                    break;
                case 'gunungkidul':
                    $this->ModelLokasi->updateDataGunkid($id_lokasi, $data);
                    break;
                case 'kulonprogo':
                    $this->ModelLokasi->updateDataKulprog($id_lokasi, $data);
                    break;
                default:
                    // Handle default case if needed
                    break;
            ...
            //jika tidak lolos validasi
            return redirect()->to('Lokasi/editLokasi/' . $wilayah . '/' . $id_lokasi)->withInput();
        }
    ...
    // }
    //FUNGSI DELETE
    public function deleteLokasi($id_lokasi, $wilayah)
    {
        switch ($wilayah) {
            case 'sleman':
                $this->ModelLokasi->deleteDataSleman(['no' => $id_lokasi]);
