...
<body>
    ...
    <div class="row">
        ...
        <div class="col-sm-4" style="position: relative; top:40px; font-size: 14px;">
            <h2 style="font-size: 18px; text-align: center;"><b>Pilih Wilayah</b></h2>
            <hr>
            <div class="row">
                <select id="wilayahSelect" class="form-control">
        ...
        <div class="col-sm-4" style="position: relative; top:40px; font-size: 14px;">
            ...
            <div class="row">
                ...
                <?php echo form_open_multipart('', 'id="dataForm"') ?>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            dataForm.addEventListener("submit", function(event) {
                ...
                this.action = "Lokasi/insertData" + selectedWilayah.charAt(0).toUpperCase() + selectedWilayah.slice(1);
