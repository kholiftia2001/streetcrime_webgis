    ...
    <header id="header" class="fixed-top d-flex align-items-center" style="height: 30px; background-color: #025464;">
        <div class="container d-flex align-items-center justify-content-between">
            <h4 class="logo" style="font-size: 16px; text-decoration: none; border-left: none; margin-right: auto; text-transform: none;">
                <a href="index.html">Data Lokasi Kejahatan Jalanan Bantul</a>
            </h4>
    ...
    <div id="layoutSidenav_content" style="position: relative; top:30px">
        <main>
            <div class="container-fluid px-4">
                <h4 class="mb-30 mt-4">Data Lokasi Kejahatan Jalanan Kabupaten Bantul</h4>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            <?php $no = 1;
                            foreach ($lokasi_bantul as $key => $value) { ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    ...
                                    <td>
                                        <a href=" <?= base_url('lokasi/editLokasiBantul/' . $value['no']) ?>" class=" btn btn-warning" style="font-size: 14px;">Sunting</a>
                                        <a href="<?= base_url('lokasi/deleteLokasiBantul/' . $value['no']) ?>" class="btn btn-danger" onclick="return confirm('Anda yakin akan menghapus data?')" style="font-size: 14px;">Hapus !</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
