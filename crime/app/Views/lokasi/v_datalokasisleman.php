    ...
    <header id="header" class="fixed-top d-flex align-items-center" style="height: 30px; background-color: #025464;">
        <div class="container d-flex align-items-center justify-content-between">
            <h4 class="logo" style="font-size: 16px; text-decoration: none; border-left: none; margin-right: auto; text-transform: none;">
                <a href="index.html">Data Lokasi Kejahatan Jalanan Sleman</a>
            </h4>
    ...
    <div id="layoutSidenav_content" style="position: relative; top:30px">
        <main>
            <div class="container-fluid px-4">
                <h4 class="mb-30 mt-4">Data Lokasi Kejahatan Jalanan Kabupaten Sleman</h4>
                        ...
                        <tbody>
                            ...
                            foreach ($lokasi_sleman as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href=" <?= base_url('lokasi/editLokasiSleman/' . $value['no']) ?>" class=" btn btn-warning" style="font-size: 14px;">Sunting</a>
                                        <a href="<?= base_url('lokasi/deleteLokasiSleman/' . $value['no']) ?>" class="btn btn-danger" onclick="return confirm('Anda yakin akan menghapus data?')" style="font-size: 14px;">Hapus !</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
