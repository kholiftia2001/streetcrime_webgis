...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center" style="height: 30px; background-color: #025464;">
        <div class="container d-flex align-items-center justify-content-between">
            <h4 class="logo" style="font-size: 16px; text-decoration: none; border-left: none; margin-right: auto; text-transform: none;">
                <a href="index.html">Sunting Lokasi Gunung Kidul</a>
            </h4>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div id="map" style="width: 100%; height:40%; position: absolute; top:0px"></div>
        </div>

        <div class="col-sm-4 justify-content-center align-items-center" style="position: absolute; top: 45%; left: 5px; font-size: 14px;">
            <h2 style="font-size: 18px; text-align: center;"><b>Sunting Data Kabupaten Gunung Kidul</b></h2>
            <hr>
            <div class="row">
                <?php
                ...
                <?php echo form_open_multipart('Lokasi/updateDataGunungkidul/' . $lokasi['no']) ?>

                <div class="form-group">
                    <label>No</label>
                    <input class="form-control" name="no" value="<?= $lokasi['no'] ?>">
            ...
            <a href="<?= base_url('Lokasi/dataLokasiGunkid') ?>" class="btn btn-success" style="font-size: 14px;">Kembali</a>
