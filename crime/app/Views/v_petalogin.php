...
<body>
    <header id="header" class="fixed-top d-flex align-items-center" style="height: 5%; background-color: #025464;">
        <div class=" container d-flex align-items-center justify-content-between">
            ...
            <h1 class="logo" style="font-size: 14px; text-decoration: none; border-left: none; margin-right: auto; text-transform: none;"><a href="<?= base_url('Lokasi') ?>">Pemetaan Lokasi Kejahatan Jalanan</a></h1>
    ...
    <div id="welcome-popup" class="welcome-popup">
        ...
        <br><br>Untuk melihat persebaran lokasi kejahatan jalanan tiap kalurahan, silakan aktifkan layer <b>Batas Administrasi</b>. Panduan lengkap dapat diakses pada menu <b>Panduan</b>".</p>
    </div>
    </div>
...
<!--            <img src="<?= base_url('sigali/') ?>assets/images/panduanpeta.png" alt="Panduan Gambar" />-->
<!--        </div>-->
<!--    </div>-->
<!--</div>-->
        <div id="panduan-popup" class="popup-panduan">
