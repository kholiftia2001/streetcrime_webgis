...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="<?= base_url('Home') ?>">SIJAGA</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#why-us">Tips & Trik</a></li>
    ...
    <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">Selamat Datang ke <span>SIJAGA</span></h2>
          <p class="animate__animated animate__fadeInUp">SIJAGA merupakan akronim dari Sistem Informasi Kejahatan Jalanan Yogyakarta.
            Sistem informasi ini memuat peta, data, dan edukasi mengenai kejahatan jalanan di Daerah Istimewa
            Yogyakarta.</p>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          ...
          <a href="<?= base_url('Home/peta') ?>" class="btn-get-started animate__animated animate__fadeInUp scrollto">Buka Peta</a>
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          ...
          <a href="<?= base_url('Home/edukasi') ?>" class="btn-get-started animate__animated animate__fadeInUp scrollto">Buka Konten Edukasi</a>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" style="margin-top: 10px;">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="<?= base_url('Home/peta') ?>">Peta Persebaran</a></h4>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="50" style="margin-top: 10px;">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="<?= base_url('Home/spatiotemporal') ?>">Animasi Spasio Temporal</a></h4>
              <p class="description">Animasi spasio temporal menyediakan informasi mengenai kejadian kejahatan jalanan berdasarkan aspek keruangan dan waktu</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="100" style="margin-top: 10px;">
            <div class="icon-box">
              ...
              <h4 class="title"><a href=<?= base_url('Home/data') ?>>Data Tabular</a></h4>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="150" style="margin-top: 10px;">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="<?= base_url('Home/kontakps') ?>">Daftar Kontak Polsek</a></h4>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="200" style="margin-top: 10px;">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="<?= base_url('Home/kontakrs') ?>">Daftar Kontak Rumah Sakit</a></h4>
              <p class="description">Daftar kontak menyajikan data dalam bentuk tabel yang berisi daftar kontak
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="250" style="margin-top: 10px;">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="<?= base_url('Home/edukasi') ?>">Edukasi</a></h4>
      ...
      <div class="container">
        ...
        <div class="row" data-aos="zoom-in">
          ...
          <div class="col-lg-3 cta-btn-container text-center">
            <a class="cta-btn align-middle" href="https://forms.gle/s2hEM3Kvb8Pxmeu2A">Isi Kuesioner</a>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h4>Hubungi Kami</h4>
            <p>
              Teknik Geodesi <br> Fakultas Teknik Universitas Gadjah Mada. <br> Jl. Grafika No.2, Bulaksumur, Yogyakarta, 55281<br><br>
          ...
          <div class="col-lg-3 col-md-6 footer-info">
            ...
            <div>
                <!--<a style="color: white; font-size: 11;" href="https://geodesi.ugm.ac.id/"><i>Selengkapnya</i></a>-->
              <!--<a href="#" class="website"><i class="bx bxl-website"></i></a>-->
